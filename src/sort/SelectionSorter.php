...
class SelectionSorter
{
     ...
     * Суть - начиная с очередной позиции алгоритм находит наименьший элемент справа
     * затем текущий элемент и наименьший меняются местами, переходим к следующему элементу
     *
